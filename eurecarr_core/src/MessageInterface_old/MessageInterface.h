...
public:
    ...
    const double SERVO_ALPHA_S = 360; ///< Coefficient for calculating steering angle
    const double SERVO_ALPHA_T = 150; ///< Coefficient for calculating steering angle
    const double SERVO_BETA_S = 1500; ///< Coefficient for calculating steering angle
    const double SERVO_BETA_T = 1600; ///< Coefficient for calculating steering angle
