...
class PoseToOdom:
    ...
    def groundPoseSubCallback(self, pose_msg):
        ...
        self.cur_pose_odom.header.stamp = cur_pose_stamp
        ...
        self.cur_pose_odom.twist.twist.angular.x = self.roll_rate_lpf.lpf(self.roll_rate)
        self.cur_pose_odom.twist.twist.angular.y = self.pitch_rate_lpf.lpf(self.pitch_rate)
        self.cur_pose_odom.twist.twist.angular.z = self.yaw_rate_lpf.lpf(self.yaw_rate)
    ...
    def poseSubCallback(self, pose_msg):
        ...
        # v_x = (self.last_pose_msg.pose.position.x - x) / dt
        # if v_x - self.last_v_x > 0.5:
        #     v_x = self.last_v_x + 0.5
        # v_y = (self.last_pose_msg.pose.position.y - y) / dt
        # if v_y - self.last_v_y > 0.5:
        #     v_y = self.last_v_y + 0.5 
        # v_z = (self.last_pose_msg.pose.position.z - z) / dt
        # if v_z - self.last_v_z > 0.5:
        #     v_z = self.last_v_z + 0.5
